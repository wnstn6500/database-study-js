...
-- 산술 연산자 활용 예
-- SELECT문에서의 산술 연산 예시
SELECT *, price / gram * 100 AS 'price / 100g' -- 따옴표("",'')
-- 또는 백틱(``)으로 감싸기
FROM burgers;
-- 100g당 가격을 계산하여 price/100g이라는 별칭(alias)으로 변경함
...
-- students 테이블 생성
create table students(id integer, nickname varchar(50)
		, math integer, english integer, programming integer,
        primary key(id));
